...
namespace Demo.Framework.Core.Globalization.Models
{
    /// <summary>
    ...
    public class GlobalizationException : Exception
    {
        ...
        public GlobalizationException(string messageFormat, params object[] args)
        ...
        protected GlobalizationException(SerializationInfo
